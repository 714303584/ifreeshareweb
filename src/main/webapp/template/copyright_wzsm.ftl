...
<!--==============================content=================================-->
  <div class="breadcrumb-wrapper">
    ...
    <div class="container">
          <h2>网站声明<small>关于本网站的使用声明</small></h2>
    </div>
  </div>
<!--=========== Scaffolding ===========-->
<div id="content">
  ...
  <div class="row">
    <div class="span3 bs-docs-sidebar">
      <ul class="nav nav-list bs-docs-sidenav">
        <li><a href="#global"><i class="icon-chevron-right"></i> 版权声明</a></li>
        <li><a href="#fwnr"><i class="icon-chevron-right"></i> 服务内容</a></li>
        <li><a href="#mzsm"><i class="icon-chevron-right"></i> 免责声明</a></li>
        <li><a href="#scnr"><i class="icon-chevron-right"></i>上传内容</a></li>
        <li><a href="#zzfw"><i class="icon-chevron-right"></i>终止服务</a></li>
      </ul>
    </div>
    <div class="span9">
      ...
      <section id="fwnr">
        ...
        <p>一旦您注册成为本网站（网址为：www.doc88.com）的用户，便表示您（以下简称“用户”）已经完全理解并同意接受本协议（以下简称“协议”）。</p>
