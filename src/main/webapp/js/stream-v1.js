...
(function(){
	...
	function Main(cfg){
		...
		this.config = {
			...
			uniqueCheck: cfg.uniqueCheck,			//the MD5 of File
	...
	Main.prototype = {
		...
		fileSelect : function(a) {
			...
			for (c = 0; c < a.length; c++){
				if(this.validateFile(a[c])){
					...
					this.get("uniqueCheck")(a[c],files[c]);
		...
		validateFile : function(uploader) {
			...
			valid && this.config.customered 
			//this.get("onAddTask")(info) && this.get("onAddTask")(info);
			return valid;
		},
